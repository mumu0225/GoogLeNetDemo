...
dataloaders = {x: torch.utils.data.DataLoader(image_datasets[x], batch_size=32, shuffle=True, num_workers=0, drop_last=True) for x in ['train', 'val']}
...
# 手动选择需要解冻的层名
layers_to_unfreeze = ['features.7', 'features.8', 'features.9']
...
# 检查params_to_update是否为空
if not params_to_update:
    raise ValueError("No parameters to update. Please check the model's layer names.")
